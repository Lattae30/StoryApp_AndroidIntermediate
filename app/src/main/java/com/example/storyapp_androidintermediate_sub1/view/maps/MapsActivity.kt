...
import com.example.storyapp_androidintermediate_sub1.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getStoriesWithLocation().observe(this, Observer { resultState ->
            when (resultState) {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(MarkerOptions().position(jakarta).title("Jakarta"))
    ...
    private fun addMarkers(data: List<ListStoryItem>) {
        data.forEach { data ->
